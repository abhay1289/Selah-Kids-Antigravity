...
const MUSIC_PLATFORMS = [
  {
    name: "Spotify",
    description: "Stream our worship songs on Spotify",
    color: "bg-[#1DB954]",
  ...
  },
  {
    ...
    color: "bg-gradient-to-br from-[#FC3C44] to-[#FC6E29]",
    textColor: "text-white",
  ...
  {
    name: "YouTube Music",
    description: "Watch & listen on YouTube Music",
    color: "bg-[#FF0000]",
    textColor: "text-white",
    ...
    <div className="bg-gradient-to-b from-[#FFF5EE] via-[#FDFBF7] to-[#F5FBF0] min-h-screen pt-36 md:pt-44 pb-16">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h1 className="hero-headline mb-4 tracking-tight">Listen to Selah Kids</h1>
        ...
        <div className="grid gap-4">
          {MUSIC_PLATFORMS.map((platform, i) => (
            <motion.a
              ...
              className={`flex items-center justify-between gap-4 p-6 rounded-2xl ${platform.color} ${platform.textColor} shadow-lg hover:shadow-xl transition-all duration-300 group`}
            >
