...
export default function UserRoles() {
  ...
  const updateRole = (id: string, role: string) => setUsers(users.map(u => u.id === id ? { ...u, role: role as any } : u));
