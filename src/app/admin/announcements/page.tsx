...
export default function AnnouncementBar() {
  ...
  const update = (id: string, field: keyof Banner, value: any) => setBanners(banners.map(b => b.id === id ? { ...b, [field]: value } : b));
