...
const RESOURCES = [
  {
    ...
    descriptionEs: "Una colorida página para colorear de Andy y su oveja mascota, Shiloh.",
    type: "PDF",
    category: "Printables",
    categoryEs: "Imprimibles",
  ...
  },
  {
    ...
    descriptionEs: "¡Una divertida página para colorear de la oveja Shiloh!",
    type: "PDF",
    category: "Printables",
    categoryEs: "Imprimibles",
  ...
  },
  {
    ...
    titleEs: "Página para Colorear de Mejores Amigos",
    description: "Color Andy, Libni, and Shiloh together in this beautiful coloring page.",
    descriptionEs: "Colorea a Andy, Libni y Shiloh juntos en esta hermosa página para colorear.",
    type: "PDF",
    category: "Printables",
    categoryEs: "Imprimibles",
  ...
  },
  {
    ...
    descriptionEs: "Una guía curricular de 4 semanas usando videos de Selah Kids para el ministerio infantil.",
    type: "PDF",
    category: "Lessons",
    categoryEs: "Lecciones",
    gradient: "from-[#98FF98] to-[#93D35C]",
    featured: true,
    comingSoon: true,
  },
  {
    ...
    descriptionEs: "Una semana de devocionales diarios diseñados para ayudar a las familias a adorar y aprender juntas.",
    type: "PDF",
    category: "Devotionals",
    categoryEs: "Devocionales",
