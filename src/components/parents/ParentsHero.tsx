          ...
          <div className="relative bg-white rounded-[3rem] p-12 shadow-2xl border border-black/5 transform hover:rotate-0 transition-transform duration-700">
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-6">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.5 }} className="bg-[#00BFFF]/10 rounded-3xl p-6 aspect-square flex items-center justify-center">
                  <Shield size={48} className="text-[#00BFFF]" />
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 0.5 }} className="bg-[#FF69B4]/10 rounded-3xl p-6 aspect-square flex items-center justify-center">
                  <Heart size={48} className="text-[#FF69B4]" />
                </motion.div>
              </div>
              <div className="space-y-6 mt-12">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7, duration: 0.5 }} className="bg-selah-yellow/10 rounded-3xl p-6 aspect-square flex items-center justify-center">
                  <BookOpen size={48} className="text-selah-yellow" />
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8, duration: 0.5 }} className="bg-[#98FF98]/20 rounded-3xl p-6 aspect-square flex items-center justify-center">
