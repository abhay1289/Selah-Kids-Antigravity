...
export function Footer() {
  ...
  return (
    <footer className="relative bg-selah-dark pt-20 pb-12 overflow-hidden">
      ...
      <div className="absolute -bottom-48 -right-48 w-[600px] h-[600px] bg-selah-blue/10 blur-[150px] rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-20">
          ...
          >
            <Link href="/" className="flex items-center gap-4 mb-8 group/logo">
              ...
              <span className="font-black text-4xl tracking-tighter text-white group-hover/logo:text-selah-orange transition-colors duration-500">
            ...
            <div className="flex gap-4">
              {[
                ...
                <motion.a 
                  ...
                  whileTap={{ scale: 0.9 }}
                  className={`w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center transition-all duration-500 group/icon ${color} ${shadow} hover:text-white hover:border-transparent`}
                >
                  <Icon size={24} className="text-white/70 group-hover/icon:text-white transition-colors duration-300" />
                </motion.a>
              ))}
            </div>
          </motion.div>
