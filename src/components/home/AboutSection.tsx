...
export function AboutSection({ fields }: { fields?: PageFieldMap } = {}) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        ...
        >
          <SectionHeader
            badge={f("about.about_badge", "Our Mission", "Nuestra Misión")}
            title={f("about.about_title", "The Selah Kids Story", "La Historia de Selah Kids")}
            description={f(
          ...
          >
            ...
            >
              {f("about.about_cta", "Read Our Full Story", "Lee Nuestra Historia Completa")}
