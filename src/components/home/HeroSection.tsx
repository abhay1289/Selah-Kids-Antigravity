    ...
    >
      ...
      >
        ...
        <motion.div 
          ...
          className="absolute top-[80%] sm:top-[60%] md:top-[50%] -translate-y-1/2 left-0 -ml-[5%] sm:ml-4 md:ml-12 w-[40%] sm:w-[30%] md:w-[22%] z-0 md:z-20 opacity-30 sm:opacity-50 md:opacity-100 pointer-events-none"
        >
          <motion.div
        ...
        <motion.div 
          ...
          className="absolute top-[80%] sm:top-[60%] md:top-[50%] -translate-y-1/2 right-0 -mr-[5%] sm:mr-4 md:mr-12 w-[40%] sm:w-[30%] md:w-[22%] z-0 md:z-20 opacity-30 sm:opacity-50 md:opacity-100 pointer-events-none"
        >
          <motion.div
