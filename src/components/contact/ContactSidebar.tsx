...
export const ContactSidebar = () => {
  const { t } = useLanguage();
  return (
    <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="lg:col-span-5 space-y-6">
      <motion.div variants={slideInRight} whileHover={{ scale: 1.02, x: -10 }} className="bg-white rounded-[3rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-black/5 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 cursor-pointer group">
        ...
        <a href="mailto:info.selahkids@gmail.com" className="body-text hover:text-selah-dark transition-colors">info.selahkids@gmail.com</a>
      </motion.div>
      ...
      <motion.div variants={slideInRight} whileHover={{ scale: 1.02, x: -10 }} className="bg-white rounded-[3rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-black/5 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 cursor-pointer group">
        ...
        <a href="mailto:partners@selahkids.com" className="body-text hover:text-selah-dark transition-colors">partners@selahkids.com</a>
      </motion.div>

      <motion.div variants={slideInRight} whileHover={{ scale: 1.02, x: -10 }} className="bg-white rounded-[3rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-black/5 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 cursor-pointer group">
        <h3 className="content-h3 mb-2 group-hover:text-[#FF69B4] transition-colors">{t("Press & Media", "Prensa y Medios")}</h3>
        <a href="mailto:press@selahkids.com" className="body-text hover:text-selah-dark transition-colors">press@selahkids.com</a>
      </motion.div>
      ...
      <motion.div variants={fadeInRight} className="bg-gradient-to-br from-selah-orange to-selah-yellow rounded-[3rem] p-10 text-center shadow-[0_20px_40px_-15px_rgba(255,92,0,0.3)] mt-10 relative overflow-hidden group">
        ...
        <h3 className="content-h3 text-white mb-8 relative z-10">{t("Follow Us", "Síguenos")}</h3>
        <div className="flex items-center justify-center gap-6 relative z-10">
          {[
            ...
            <button key={i} aria-label={social.name} className={`w-16 h-16 rounded-full bg-white/10 flex items-center justify-center text-white transition-all duration-500 ${social.color} hover:scale-110 hover:shadow-[0_10px_20px_rgba(0,0,0,0.3)] hover:-translate-y-2`}>
              <social.icon size={28} />
            </button>
          ))}
        </div>
